...
export default function Step3({active, onForward, onBackward, timeRange, songs, radio, setSongs}) {
    ...
    function startSearch() {
        ...
        fetch(`/api/odslynx/getTracks?radioID=${radioID}&startDate=${new Date(timeRange.startDate).getTime()}&endDate=${new Date(timeRange.endDate).getTime()}&startHour=${timeRange.startHour}&endHour=${timeRange.endHour}`)
